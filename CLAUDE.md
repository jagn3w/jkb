...
- **One member of the set does not live under `docs/`.** `.container/README.md` is the container's
  ...
  mount list as the security boundary — in the README rather than in
  `docs/sandbox-and-container.md`. The README was
